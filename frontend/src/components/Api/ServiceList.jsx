        ...
        return (
            <>
                ...
                {currentServices.map(service => (
                    <div className="col-md-4 ftco-animate" key={service.id}>
                        <div className="project-wrap">
                            <a className="img" style={{ backgroundImage: `url(/img/${service.image})` }}></a>
                                ...
                                <div className="modal-content">
                                    ...
                                    <div className="modal-body">
                                        ...
                                        <div className="mb-3 text-center">
                                            <img
                                                src={`/img/${this.state.selectedService.image}`}
                                                alt="Service Image"
                                                className="img-fluid"
                                            />
                                        </div>
